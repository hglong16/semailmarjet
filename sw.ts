...
const url1 =
  "https://spiderum.com/bai-dang/Nguoi-trong-muon-nghe-Kenh-podcast-co-gi-3yxsRRdQBy03";
let url2: string = "https://spiderum.com/bai-dang/Phu-thuy-thoi-gian-lw8";
let url3: string =
  "https://spiderum.com/bai-dang/Tu-Ton-Dan-Toc-Thai-Qua-Hay-Boi-Ban-La-Dua-Me-Tay-Vong-Ngoai-dhd";
let url4: string =
  "https://spiderum.com/bai-dang/Cau-Vang-Thoi-dai-khan-gia-ti-toe-lam-Thuong-De-i4i";
let url5: string =
  "https://spiderum.com/bai-dang/TU-MOT-DUA-KHONG-THE-CHAY-CHO-TOI-MOT-NGUOI-CHAY-10KM-MOI-NGAY-we0Fyx0WGfX0";
let url6: string = " https://spiderum.com/bai-dang/STEM-va-tinh-kien-nhan-h39";
let url7: string =
  "https://spiderum.com/bai-dang/Cau-Chuyen-Tesla-Xay-Nha-May-O-Duc-0rvhQ462J03U";
let url8: string =
  "https://spiderum.com/bai-dang/Tai-sao-dia-ly-nuoc-Nga-lai-TE-cTQPQLWJJwHd";
let url9: string =
  "https://spiderum.com/bai-dang/Sony-vu-hack-vao-Play-Station-Network-va-BKAV-jy0k6s0NWPJZ";
...
@media (min-width: 385px) {
 ...
 .sub-content {
   ...
   width: calc(93.5% - 128px)!important;
 }
 .sub-2 {
 ...
 <mj-body width="680px">
           ...
           <div class="container">
             ...
             <div class="sub-content" style="margin: 0 0 0 18px">
               <p style="font-size: 12px; line-height: 0px">
                 <a href='${article2["categoryLink"]}'>${article2['category']}</a> |
                 <span style="color: #616161"> </span>
               </p>
               <!-- sub title -->
               <p class="sub-title" style="margin: 0">
                 <a
                   href="${url2}"
                   >${article2['title']}
                 </a>
       ...
       <mj-column width="89.58%" padding="0 0 0 0">
         <mj-raw>
           <div class="container">
             ...
             <div class="sub-content" style="margin: 0 0 0 18px">
               <p style="font-size: 12px; line-height: 0px">
                 <a href='${article5["categoryLink"]}'>${article5['category']}</a> |
                 <span style="color: #616161"> </span>
               </p>
               <!-- sub title -->
               <p class="sub-title" style="margin: 0">
       ...
       <mj-column css-class="sub-2" width="89.58%" padding="0 0 36px 0">
         <mj-raw>
           <div class="container">
             ...
             <div class="sub-content" style="margin: 0 0 0 18px">
               <p style="font-size: 12px; line-height: 0px">
                 <a href="${article6['categoryLink']}}">${article6['category']}</a> |
                 <span style="color: #616161"> </span>
               </p>
               <!-- sub title -->
               <p class="sub-title" style="margin: 0">
             ...
             >
               <div>
                 ...
                 <p
                   ...
                   "
                 >
                   <span style="font-weight: 700">${article7['author']}</span>
                 </p>
                 <p
                   style="
                     font-size: 12px;
       ...
       <mj-column width="89.58%" padding="0 0 0 0">
         <mj-raw>
           <div class="container">
             ...
             <div class="sub-content" style="margin: 0 0 0 18px">
               <p style="font-size: 12px; line-height: 0px">
                 <a href='${article8["categoryLink"]}'>${article8['category']}</a> |
                 <span style="color: #616161"> </span>
               </p>
               <!-- sub title -->
               <p class="sub-title" style="margin: 0">
               ...
               >
                 ...
                 <div class="sub-author-container" style="padding-left: 12px">
                   ...
                   ><a href="${article8['authorLink']}">
                     ...
                     <span style="font-weight: 700">${article8['author']}</span>
                   </p>
                   <p
                     style="
                       font-size: 12px;
       ...
       <mj-column css-class="sub-2" width="89.58%" padding="0 0 36px 0">
         <mj-raw>
           <div class="container">
             ...
             <div class="sub-content" style="margin: 0 0 0 18px">
               <p style="font-size: 12px; line-height: 0px">
                 <a href="${article9['categoryLink']}}">${article9['category']}</a> |
                 <span style="color: #616161"> </span>
               </p>
               <!-- sub title -->
               <p class="sub-title" style="margin: 0">
               ...
               >
                 ...
                 <div class="sub-author-container" style="padding-left: 12px">
                   ...
                   ><a href="${article9['authorLink']}">
                     ...
                     <span style="font-weight: 700">${article9['author']}</span>
                   </p>
                   <p
                     style="
                       font-size: 12px;
   ...
   <mj-section>
     <mj-column width="87.5%">
       <mj-text align="center" font-size="12px" line-height="20px" font-family="Noto Sans,sans-serif">
         <p>
           Theo dõi những chủ đề bạn quan tâm hoặc bỏ theo dõi chúng
           <a class="link-blue" href="/" style="font-weight: 700; color:#3398D4">qua đây</a>
         </p>
